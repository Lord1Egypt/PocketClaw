...
| **Verification APK (PC-DEF-075 canonical bot link)** | `643c2495a529465eff03c12ebe3a17fb82c153affe9fd38e90718bcb88da2f72`, 63,632,335 bytes, `0.2.0+62`, development signer `15cf75f9…`, Dart AOT `5c0f5825…`, Core fingerprint `87c320c1…`, Core BuildTime `2026-09-21T03:22:04+0000`. Source gate 29/29, Go vet/test exit 0, frontend 577 passed, `tsc`/ESLint clean, `flutter analyze` clean. Installed on the Samsung; runtime confirmed up. Archived read-only at `build/forensic/apk-643c2495…/`. **v0.2.0 publication is blocked until the Open chat physical retest passes.** LOCAL TEST / NON-RELEASABLE |
...
here. Publication is blocked only on the Open chat physical retest. Production
signing was never started: the keystore passwords are owner-held and outside
