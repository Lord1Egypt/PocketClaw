...
| Version | `0.2.3+65` on `release/v0.2.3-fdroid-hardening` — Golden #4 accepted physically 2026-09-25; latest published remains v0.2.2 until the v0.2.3 release is published |
