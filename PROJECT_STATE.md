...
| Core fingerprint | `762d1502af3ecfd56174fda67b09b7d5bfee7f95f2a0ff8c63aab4ba0812ac99`; the staged Core pair carries it — last moved by the PC-DEF-073 guard in the launcher backend |
...
| Staged Core freshness | **CURRENT.** Rebuilt from the source commit `c71f4ad` and staged in `63fae9f`, which touches no build input. Fingerprint `762d1502af3ecfd56174fda67b09b7d5bfee7f95f2a0ff8c63aab4ba0812ac99` (was `d6a606ad…`), BuildTime `2026-09-20T21:00:32+0000`. `core.staged_freshness` and `native.elf_audit_contract` both pass |
