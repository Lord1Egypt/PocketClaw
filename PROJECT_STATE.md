...
| Core fingerprint | `d6a606adc3aa6756efcc39ab27824199316f42f3943df0ffdcd27ef118a966c2`; the staged Core pair carries it — last moved by the PC-DEF-071 dashboard change, which is a Core build input |
...
| Staged Core freshness | **CURRENT.** Rebuilt from the source commit `fffb52b` and staged in `462c049`, which touches no build input. Fingerprint `d6a606adc3aa6756efcc39ab27824199316f42f3943df0ffdcd27ef118a966c2` (was `f2fd1ee7…`), BuildTime `2026-09-20T20:20:12+0000`. `core.staged_freshness` and `native.elf_audit_contract` both pass |
