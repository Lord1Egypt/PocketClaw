...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get whatsNew020New5 =>
      'ワンタップの Telegram 設定：PocketClaw があなた専用のボットを作成します。アプリからでも、ブラウザのダッシュボードからでも可能です。トークンをコピーする必要はなく、話しかけられるのはあなたのアカウントだけです。';
  ...
  @override
  String get notificationPermissionGranted => 'PocketClaw は実行中の通知を表示できます。';

  @override
  String get notificationPermissionBlocked =>
      '通知がオフのため、PocketClaw の実行中通知は表示されません。';

  @override
  String get notificationPermissionOpenSettings => '通知設定を開く';

  @override
  String get whatsNew020New7 => 'ダッシュボードからの Telegram 管理：ボットの接続、差し替え、接続解除。';

  @override
  String get whatsNew020New8 =>
      'ダッシュボードでのプロバイダーとモデルの管理：プロバイダーの追加、API キーの入れ替え、モデルの削除。';

  @override
  String get whatsNew020Improvement12 =>
      'Telegram の設定は保存した時点で適用され、手動での再起動は不要です。';

  @override
  String get whatsNew020Improvement13 =>
      'AI モデルが未設定のとき、PocketClaw は何が足りないかを正確に示し、調べるためのコードを提示します。';

  @override
  String get whatsNew020Improvement14 => 'ダッシュボードにサインインすると、開こうとしていた画面に戻ります。';

  @override
  String get whatsNew020Improvement15 =>
      '診断ログは詳細さを保ちながら、鍵やトークン、メッセージ本文を含むことはありません。';

  @override
  String get whatsNew020Improvement16 =>
      'まだ誰のものにもなっていないダッシュボードは、パブリックモードが有効でもネットワークから到達できません。';
}
